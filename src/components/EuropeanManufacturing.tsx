      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-3xl mx-auto mb-10 leading-relaxed">
            Apex enclosures are built by Eurotech Metal Industries — an ISO 9001/14001/45001 certified facility that supplies precision components to Schneider Electric. Every unit passes the same quality standards used for industrial electrical enclosures.
          </p>
