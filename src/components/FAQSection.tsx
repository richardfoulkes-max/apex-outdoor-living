...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "We use 3 industrial Delta fans that deliver over 200 CFM of airflow. The system is temperature-controlled: it automatically adjusts fan speed based on internal temperature, keeping your TV within safe operating ranges even when ambient temperatures hit 55°C.",
    },
    {
